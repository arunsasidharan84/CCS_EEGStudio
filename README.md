...
|------------------|--------------|---------------|
| **macOS** | Universal ZIP (.app) | [Download macOS](https://github.com/arunsasidharan84/CCS_EEGStudio/releases/download/v1.1.1/CCSEEGStudio-macos.zip) |
| **Windows** | x64 Installer EXE | [Download Windows](https://github.com/arunsasidharan84/CCS_EEGStudio/releases/download/v1.1.1/CCSEEGStudio-Installer.exe) |
| **Linux (Debian/Ubuntu)** | x64 DEB Installer | [Download Linux DEB](https://github.com/arunsasidharan84/CCS_EEGStudio/releases/download/v1.1.1/CCSEEGStudio-linux-amd64.deb) |
| **Linux (RHEL/AlmaLinux)** | x86_64 RPM Installer | [Download Linux RPM](https://github.com/arunsasidharan84/CCS_EEGStudio/releases/download/v1.1.1/CCSEEGStudio-linux-x86_64.rpm) |
